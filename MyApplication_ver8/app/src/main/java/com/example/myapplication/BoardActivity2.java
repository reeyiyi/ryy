...
public class BoardActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boardListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(BoardActivity2.this , BoardDetailActivity.class);
    ...
    class board extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://holy97.cafe24.com/myphp/BoardList2.php?bid="+bid+"&superId="+UserDTO.superId;
